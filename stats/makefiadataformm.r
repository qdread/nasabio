...
# Edited 04 Jan 2019: change filepaths
...
fpfiabio <- file.path(fp, 'biodiversity_CSVs/updated_nov2018')
ad <- read.csv(file.path(fpfiabio, 'fiausa_natural_alpha.csv'), stringsAsFactors = FALSE)
bd <- read.csv(file.path(fpfiabio, 'fiausa_natural_beta.csv'), stringsAsFactors = FALSE)
gd <- read.csv(file.path(fpfiabio, 'fiausa_natural_gamma.csv'), stringsAsFactors = FALSE)
...
write.csv(fiabio, file.path(fpfiabio, 'fia_bio_formixedmodels_50k.csv'), row.names = FALSE)
