...
prednames <- c('elevation_5k_50_sd', 'bio1_5k_50_mean', 'geological_age_5k_50_diversity', 'soil_type_5k_50_diversity', 'bio12_5k_50_mean', 'bio12_5k_50_sd', 'dhi_gpp_5k_50_sd', 'human_footprint_5k_50_mean')
...
# Save all fits
save(fit, file = paste0('/mnt/research/nasabio/temp/spammfit50k/fit',task,'.RData'))
