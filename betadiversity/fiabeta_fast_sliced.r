...
write.csv(fia_betadiv, file = paste0('/mnt/research/nasabio/data/fia/betaoutput/sliced/tdpdfd_',as.character(as.integer(r)),'_',slice,'.csv'), row.names = FALSE)						  