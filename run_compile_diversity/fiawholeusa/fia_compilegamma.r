...
for (i in 1:1500) {
  load(paste0('/mnt/research/nasabio/data/fia/diversity/filtered/gamma_', i, '.r'))
  gamma_div_list[[i]] <- gamma_div
}
...
write.csv(gamma_div_cast, file = '/mnt/research/nasabio/data/fia/fiausa_natural_gamma.csv', row.names = FALSE)
