...
fiacoords <- fiacoords[!plantation$plantation, ]
fiaplotmat <- fiaplotmat[!plantation$plantation, ]
...
save(gamma_div, file = paste0('/mnt/research/nasabio/data/fia/diversity/filtered/gamma_', slice, '.r'))
