...
write.csv(bbs_betadiv, file = paste0('/mnt/research/nasabio/data/bbs/betaoutput/byroute/betapartfinal_',as.character(as.integer(r)),'_',slice,'.csv'), row.names = FALSE)				