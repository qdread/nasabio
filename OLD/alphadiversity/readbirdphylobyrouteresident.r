...
migrants <- bt$Latin_Name[bt$migrant_status == 1]
...
fixedbbsmat_byroute_nonzero <- fixedbbsmat_byroute_nonzero[, !(dimnames(fixedbbsmat_byroute_nonzero)[[2]] %in% c(migrants,nocturnalbirds))]
...
save(pd_ericson, mpd_ericson, mntd_ericson, file = paste0('/mnt/research/aquaxterra/DATA/raw_data/bird_traits/bird_phylogeny/pd_tree_residentpresence_',tree_to_use,'_byroute.r'))
