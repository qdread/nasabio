...
These are the coefficient estimates of the fixed effects. The predictors are scaled so that you can compare within a model. The $R^2$ of the model is shown as well.
